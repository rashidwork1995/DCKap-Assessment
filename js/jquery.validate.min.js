    ...
    d.extend(d.fn, {
                    ...
                    s.settings.onsubmit &&
                        ...
                        this.on("submit.validate", function (i) {
                            function t() {
                                var t, e;
                                return (
                                    s.submitButton && (s.settings.submitHandler || s.formSubmitted) && (t = d("<input type='hidden'/>").attr("name", s.submitButton.name).val(d(s.submitButton).val()).appendTo(s.currentForm)),
                                    !(s.settings.submitHandler && !s.settings.debug) || ((e = s.settings.submitHandler.call(s, s.currentForm, i)), t && t.remove(), void 0 !== e && e)
                                );
                            }
        ...
        rules: function (t, e) {
            ...
            if (null != l && (!l.form && h && ((l.form = this.closest("form")[0]), (l.name = this.attr("name"))), null != l.form)) {
                ...
                return (
                    (r = d.validator.normalizeRules(d.extend({}, d.validator.classRules(l), d.validator.attributeRules(l), d.validator.dataRules(l), d.validator.staticRules(l)), l)).required &&
                        ((a = r.required), delete r.required, (r = d.extend({ required: a }, r))),
                    r.remote && ((a = r.remote), delete r.remote, (r = d.extend(r, { remote: a }))),
                    r
                );
            }
        },
        ...
        (d.validator.format = function (i, t) {
            return 1 === arguments.length
                ...
                : (void 0 === t ||
                      (2 < arguments.length && t.constructor !== Array && (t = d.makeArray(arguments).slice(1)),
            ...
            prototype: {
                ...
                checkForm: function () {
                    ...
                    for (var t = 0, e = (this.currentElements = this.elements()); e[t]; t++)
                        if (null != this.findByName(e[t].name).length && 1 < this.findByName(e[t].name).length) for (var i = 0; i < this.findByName(e[t].name).length; i++) this.check(this.findByName(e[t].name)[i]);
                        else this.check(e[t]);
                    return this.valid();
                },
                element: function (t) {
                    ...
                    return d(this.currentForm)
                        ...
                        .filter(function () {
                            ...
                            return (
                                ...
                                e && ((this.form = d(this).closest("form")[0]), (this.name = t)),
                                this.form === i.currentForm && !(t in s || !i.objectLength(d(this).rules())) && (s[t] = !0)
                            );
                        });
                },
                clean: function (t) {
                ...
                showLabel: function (t, e) {
                    ...
                    a.length
				? (a.removeClass(this.settings.validClass).addClass(this.settings.errorClass), a.html(e), $('#'+(d(t).attr('id'))+'-success').hide()	)
                        : ((i = a = d("<" + this.settings.errorElement + ">")
                          ...
                          a.is("label")
                              ? a.attr("for", o)
                              : 0 === a.parents("label[for='" + this.escapeCssMeta(o) + "']").length &&
                                ((n = a.attr("id")),
                ...
                stopRequest: function (t, e) {
                    this.pendingRequest--,
                        ...
                        e && 0 === this.pendingRequest && this.formSubmitted && this.form()
                            ...
                            : !e && 0 === this.pendingRequest && this.formSubmitted && (d(this.currentForm).triggerHandler("invalid-form", [this]), (this.formSubmitted = !1));
                },
                previousValue: function (t, e) {
                    return (e = ("string" == typeof e && e) || "remote"), d.data(t, "previousValue") || d.data(t, "previousValue", { old: null, valid: !0, message: this.defaultMessage(t, { method: e }) });
                },
                destroy: function () {
                    this.resetForm(),
                        d(this.currentForm)
            ...
            normalizeRules: function (s, n) {
                return (
                    ...
                    d.validator.autoCreateRanges &&
                        (null != s.min && null != s.max && ((s.range = [s.min, s.max]), delete s.min, delete s.max),
                        null != s.minlength && null != s.maxlength && ((s.rangelength = [s.minlength, s.maxlength]), delete s.minlength, delete s.maxlength)),
                    s
                );
            },
            ...
            methods: {
                ...
                remote: function (r, a, t, o) {
                    ...
                    return (
                        ...
                        (h.originalMessage = h.originalMessage || this.settings.messages[a.name][o]),
                                      ...
                                      !0,
                                      {
                                          ...
                                          success: function (t) {
                                              ...
                                              (l.settings.messages[a.name][o] = h.originalMessage),
                                                  n
                                                      ? ((s = l.formSubmitted), l.resetInternals(), (l.toHide = l.errorsFor(a)), (l.formSubmitted = s), l.successList.push(a), (l.invalid[a.name] = !1), l.showErrors())
                                                      : ((e = {}), (i = t || l.defaultMessage(a, { method: o, parameters: r })), (e[a.name] = h.message = i), (l.invalid[a.name] = !0), l.showErrors(e)),
                                                  (h.valid = n),
                                                  l.stopRequest(a, n);
                                          },
                                      },
